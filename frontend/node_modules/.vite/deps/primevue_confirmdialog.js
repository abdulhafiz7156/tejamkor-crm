import {
  script as script2
} from "./chunk-XNPML46S.js";
import "./chunk-JDZXVNGT.js";
import {
...
var _hoisted_1 = { class: "p-confirm-dialog-message" };
  ...
  return openBlock(), createBlock(_component_CDialog, {
    ...
    default: withCtx(() => [
      !_ctx.$slots.message ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
        $data.confirmation.icon ? (openBlock(), createElementBlock("i", {
          key: 0,
          class: normalizeClass($options.iconClass)
        }, null, 2)) : createCommentVNode("", true),
        createBaseVNode("span", _hoisted_1, toDisplayString($options.message), 1)
