...
var _hoisted_2 = { class: "p-colorpicker-content" };
var _hoisted_3 = { class: "p-colorpicker-color" };
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", {
    ...
    !$props.inline ? (openBlock(), createElementBlock("input", {
      key: 0,
      ref: "input",
      type: "text",
    ...
    createVNode(_component_Portal, {
      ...
      default: withCtx(() => [
        createVNode(Transition, {
          ...
          default: withCtx(() => [
            ($props.inline ? true : $data.overlayVisible) ? (openBlock(), createElementBlock("div", {
              key: 0,
