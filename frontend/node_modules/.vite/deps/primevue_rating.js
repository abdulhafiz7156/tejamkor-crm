...
var _hoisted_4 = { class: "p-hidden-accessible" };
var _hoisted_5 = ["value", "name", "checked", "disabled", "readonly", "aria-label", "onFocus", "onChange"];
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", {
    class: normalizeClass($options.containerClass)
  }, [
    $props.cancel ? (openBlock(), createElementBlock("div", {
      key: 0,
    ...
    (openBlock(true), createElementBlock(Fragment, null, renderList($props.stars, (value) => {
      return openBlock(), createElementBlock("div", {
        ...
        value <= $props.modelValue ? renderSlot(_ctx.$slots, "onicon", {
          key: 0,
          value
        }, () => [
          createBaseVNode("span", {
