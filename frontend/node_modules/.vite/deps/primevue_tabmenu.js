...
var script = {
  ...
  methods: {
    ...
    findNextItem(items, index) {
      ...
      if (nextItem)
        return DomHandler.hasClass(nextItem, "p-disabled") ? this.findNextItem(items, i) : { nextItem, i };
      else
        return null;
    },
    findPrevItem(items, index) {
      ...
      if (prevItem)
        return DomHandler.hasClass(prevItem, "p-disabled") ? this.findPrevItem(items, i) : { prevItem, i };
      else
        return null;
    },
...
var _hoisted_1 = { class: "p-tabmenu p-component" };
...
var _hoisted_6 = ["href", "target", "aria-label", "aria-disabled", "tabindex"];
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", _hoisted_1, [
    createBaseVNode("ul", {
          ...
          item.to && !$options.disabled(item) ? (openBlock(), createBlock(_component_router_link, {
            ...
            default: withCtx(({ navigate, href, isActive, isExactActive }) => [
              $options.visible(item) ? (openBlock(), createElementBlock("li", {
                ...
                !_ctx.$slots.item ? withDirectives((openBlock(), createElementBlock("a", {
                  key: 0,
                  ref_for: true,
                  ref: "tabLink",
                  role: "menuitem",
                  ...
                  createBaseVNode("span", _hoisted_4, toDisplayString($options.label(item)), 1)
                ], 40, _hoisted_3)), [
                  [_directive_ripple]
            ...
            _: 2
          }, 1032, ["to"])) : $options.visible(item) ? (openBlock(), createElementBlock("li", {
            key: 1,
            ref_for: true,
            ref: "tab",
            ...
            !_ctx.$slots.item ? withDirectives((openBlock(), createElementBlock("a", {
              ...
              createBaseVNode("span", _hoisted_7, toDisplayString($options.label(item)), 1)
            ], 8, _hoisted_6)), [
              [_directive_ripple]
            ]) : (openBlock(), createBlock(resolveDynamicComponent(_ctx.$slots.item), {
              key: 1,
      ...
      createBaseVNode("li", _hoisted_8, null, 512)
    ], 8, _hoisted_2)
  ]);
}
