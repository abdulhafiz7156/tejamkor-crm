...
var _hoisted_1$1 = { class: "p-organizationchart-table" };
var _hoisted_2 = { key: 0 };
var _hoisted_3 = ["colspan"];
var _hoisted_4 = ["colspan"];
var _hoisted_5 = createBaseVNode("div", { class: "p-organizationchart-line-down" }, null, -1);
var _hoisted_6 = [
  _hoisted_5
];
var _hoisted_7 = ["colspan"];
var _hoisted_8 = createBaseVNode("div", { class: "p-organizationchart-line-down" }, null, -1);
var _hoisted_9 = [
  _hoisted_8
];
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("table", _hoisted_1$1, [
    createBaseVNode("tbody", null, [
      $props.node ? (openBlock(), createElementBlock("tr", _hoisted_2, [
        createBaseVNode("td", { colspan: $options.colspan }, [
          createBaseVNode("div", {
            ...
            $options.toggleable ? (openBlock(), createElementBlock("a", {
              key: 0,
              tabindex: "0",
      ...
      createBaseVNode("tr", {
        ...
        createBaseVNode("td", { colspan: $options.colspan }, _hoisted_6, 8, _hoisted_4)
      ], 4),
      createBaseVNode("tr", {
        style: normalizeStyle($options.childStyle),
        class: "p-organizationchart-lines"
      }, [
        $props.node.children && $props.node.children.length === 1 ? (openBlock(), createElementBlock("td", {
          key: 0,
...
var _hoisted_1 = { class: "p-organizationchart p-component" };
