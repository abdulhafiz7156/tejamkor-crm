...
var _hoisted_3 = { class: "p-confirm-popup-message" };
var _hoisted_4 = { class: "p-confirm-popup-footer" };
      ...
      createVNode(Transition, {
        ...
        default: withCtx(() => [
          $data.visible ? withDirectives((openBlock(), createElementBlock("div", mergeProps({
            ...
            !_ctx.$slots.message ? (openBlock(), createElementBlock("div", _hoisted_2, [
              createBaseVNode("i", {
                class: normalizeClass($options.iconClass)
              }, null, 2),
              createBaseVNode("span", _hoisted_3, toDisplayString($data.confirmation.message), 1)
