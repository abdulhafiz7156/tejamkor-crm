...
var _hoisted_4 = { class: "p-steps-number" };
var _hoisted_5 = { class: "p-steps-title" };
var _hoisted_6 = ["onKeydown"];
var _hoisted_7 = { class: "p-steps-number" };
var _hoisted_8 = { class: "p-steps-title" };
              ...
              !$options.isItemDisabled(item) ? (openBlock(), createBlock(_component_router_link, {
                ...
                default: withCtx(({ navigate, href, isActive, isExactActive }) => [
                  createBaseVNode("a", {
                    ...
                    createBaseVNode("span", _hoisted_4, toDisplayString(index + 1), 1),
                    createBaseVNode("span", _hoisted_5, toDisplayString($options.label(item)), 1)
                  ], 42, _hoisted_3)
                ]),
                _: 2
                ...
                createBaseVNode("span", _hoisted_7, toDisplayString(index + 1), 1),
                createBaseVNode("span", _hoisted_8, toDisplayString($options.label(item)), 1)
              ], 42, _hoisted_6))
