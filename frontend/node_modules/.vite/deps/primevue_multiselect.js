import {
  script as script2
} from "./chunk-276W3URV.js";
import {
  OverlayEventBus
} from "./chunk-SS62TUKS.js";
import {
  script
...
var _hoisted_2 = ["id", "disabled", "placeholder", "tabindex", "aria-label", "aria-labelledby", "aria-expanded", "aria-controls", "aria-activedescendant"];
var _hoisted_3 = { class: "p-multiselect-label-container" };
var _hoisted_4 = { class: "p-multiselect-token-label" };
var _hoisted_5 = ["onClick"];
var _hoisted_6 = { class: "p-multiselect-trigger" };
var _hoisted_7 = {
  key: 0,
  class: "p-multiselect-header"
};
var _hoisted_8 = { class: "p-hidden-accessible" };
var _hoisted_9 = ["checked", "aria-label"];
var _hoisted_10 = {
  key: 1,
  class: "p-multiselect-filter-container"
};
var _hoisted_11 = ["value", "placeholder", "aria-owns", "aria-activedescendant"];
var _hoisted_12 = {
  key: 2,
  role: "status",
  "aria-live": "polite",
...
var _hoisted_14 = ["id"];
var _hoisted_15 = ["id"];
var _hoisted_16 = ["id", "aria-label", "aria-selected", "aria-disabled", "aria-setsize", "aria-posinset", "onClick", "onMousemove"];
var _hoisted_17 = { class: "p-checkbox p-component" };
var _hoisted_18 = {
  key: 0,
            ...
            (openBlock(true), createElementBlock(Fragment, null, renderList($options.chipSelectedItems, (item) => {
              return openBlock(), createElementBlock("div", {
                ...
                renderSlot(_ctx.$slots, "chip", { value: item }, () => [
                  createBaseVNode("span", _hoisted_4, toDisplayString($options.getLabelByValue(item)), 1)
                ]),
        ...
        createVNode(Transition, {
          ...
          default: withCtx(() => [
            $data.overlayVisible ? (openBlock(), createElementBlock("div", mergeProps({
              ...
              $props.showToggleAll && $props.selectionLimit == null || $props.filter ? (openBlock(), createElementBlock("div", _hoisted_7, [
                $props.showToggleAll && $props.selectionLimit == null ? (openBlock(), createElementBlock("div", {
                  key: 0,
                ...
                $props.filter ? (openBlock(), createElementBlock("div", _hoisted_10, [
                  createBaseVNode("input", mergeProps({
                    ref: "filterInput",
                    type: "text",
                ...
                $props.filter ? (openBlock(), createElementBlock("span", _hoisted_12, toDisplayString($options.filterResultMessageText), 1)) : createCommentVNode("", true),
                    ...
                    createBaseVNode("ul", {
                      ...
                      (openBlock(true), createElementBlock(Fragment, null, renderList(items, (option, i) => {
                        return openBlock(), createElementBlock(Fragment, {
                          ...
                          $options.isOptionGroup(option) ? (openBlock(), createElementBlock("li", {
                          ...
                          ], 12, _hoisted_15)) : withDirectives((openBlock(), createElementBlock("li", {
                            key: 1,
                            id: $data.id + "_" + $options.getOptionIndex(i, getItemOptions),
                            style: normalizeStyle({ height: itemSize ? itemSize + "px" : void 0 }),
                            ...
                            renderSlot(_ctx.$slots, "option", {
                              ...
                              createBaseVNode("span", null, toDisplayString($options.getOptionLabel(option)), 1)
                            ])
                          ], 46, _hoisted_16)), [
                            [_directive_ripple]
                          ])
                      ...
                      $data.filterValue && (!items || items && items.length === 0) ? (openBlock(), createElementBlock("li", _hoisted_18, [
                        renderSlot(_ctx.$slots, "emptyfilter", {}, () => [
                          createTextVNode(toDisplayString($options.emptyFilterMessageText), 1)
                        ])
                      ])) : !$props.options || $props.options && $props.options.length === 0 ? (openBlock(), createElementBlock("li", _hoisted_19, [
              ...
              !$props.options || $props.options && $props.options.length === 0 ? (openBlock(), createElementBlock("span", _hoisted_20, toDisplayString($options.emptyMessageText), 1)) : createCommentVNode("", true),
              createBaseVNode("span", _hoisted_21, toDisplayString($options.selectedMessageText), 1),
              createBaseVNode("span", {
