    ...
    (openBlock(true), createElementBlock(Fragment, null, renderList($props.items, (processedItem, index) => {
      return openBlock(), createElementBlock(Fragment, {
        ...
        $options.isItemVisible(processedItem) && !$options.getItemProp(processedItem, "separator") ? (openBlock(), createElementBlock("li", {
          ...
          createBaseVNode("div", {
            ...
            !$props.template ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
              $options.getItemProp(processedItem, "to") && !$options.isItemDisabled(processedItem) ? (openBlock(), createBlock(_component_router_link, {
                ...
                $options.isItemGroup(processedItem) ? (openBlock(), createElementBlock("span", _hoisted_7)) : createCommentVNode("", true)
              ], 10, _hoisted_5)), [
                [_directive_ripple]
              ])
          ...
          }, null, 8, ["id", "menuId", "focusedItemId", "items", "template", "activeItemPath", "exact", "level"])) : createCommentVNode("", true)
        ...
        $options.isItemVisible(processedItem) && $options.getItemProp(processedItem, "separator") ? (openBlock(), createElementBlock("li", {
          ...
          role: "separator"
        }, null, 14, _hoisted_8)) : createCommentVNode("", true)
      ], 64);
    }), 128))
  ]);
}
...
//# sourceMappingURL=chunk-3B2GYJAN.js.map
