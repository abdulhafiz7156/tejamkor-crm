...
var _hoisted_4 = ["aria-hidden", "aria-label", "aria-roledescription"];
var _hoisted_5 = ["disabled", "aria-label"];
var _hoisted_6 = ["tabindex", "aria-label", "aria-current", "onClick"];
var _hoisted_7 = {
  key: 1,
  ...
  return openBlock(), createElementBlock("div", {
    ...
    createBaseVNode("div", {
      ...
      createBaseVNode("div", {
        ...
        $props.showNavigators ? withDirectives((openBlock(), createElementBlock("button", mergeProps({
          key: 0,
          type: "button",
        ...
        createBaseVNode("div", {
          ...
          createBaseVNode("div", {
            ...
            $options.isCircular() ? (openBlock(true), createElementBlock(Fragment, { key: 0 }, renderList($props.value.slice(-1 * $data.d_numVisible), (item, index) => {
              return openBlock(), createElementBlock("div", {
                key: index + "_scloned",
            ...
            $options.isCircular() ? (openBlock(true), createElementBlock(Fragment, { key: 1 }, renderList($props.value.slice(0, $data.d_numVisible), (item, index) => {
              return openBlock(), createElementBlock("div", {
                key: index + "_fcloned",
      ...
      $options.totalIndicators >= 0 && $props.showIndicators ? (openBlock(), createElementBlock("ul", {
        key: 0,
