...
var _hoisted_1$1 = { class: "p-submenu-list" };
var _hoisted_2$1 = ["id", "aria-label", "aria-expanded", "aria-level", "aria-setsize", "aria-posinset"];
var _hoisted_3$1 = ["onClick"];
var _hoisted_4$1 = ["href", "onClick"];
var _hoisted_5$1 = { class: "p-menuitem-text" };
var _hoisted_6$1 = ["href", "target"];
var _hoisted_7$1 = { class: "p-menuitem-text" };
var _hoisted_8$1 = { class: "p-toggleable-content" };
      ...
      return openBlock(), createElementBlock(Fragment, {
        ...
        $options.isItemVisible(processedItem) && !$options.getItemProp(processedItem, "separator") ? (openBlock(), createElementBlock("li", {
              ...
              $options.getItemProp(processedItem, "to") && !$options.isItemDisabled(processedItem) ? (openBlock(), createBlock(_component_router_link, {
                ...
                default: withCtx(({ navigate, href, isActive, isExactActive }) => [
                  withDirectives((openBlock(), createElementBlock("a", {
                    ...
                    createBaseVNode("span", _hoisted_5$1, toDisplayString($options.getItemLabel(processedItem)), 1)
                  ], 10, _hoisted_4$1)), [
                    [_directive_ripple]
                  ])
                ]),
                ...
                createBaseVNode("span", _hoisted_7$1, toDisplayString($options.getItemLabel(processedItem)), 1)
              ], 10, _hoisted_6$1)), [
                [_directive_ripple]
              ])
          ...
          createVNode(Transition, { name: "p-toggleable-content" }, {
            default: withCtx(() => [
              withDirectives(createBaseVNode("div", _hoisted_8$1, [
...
var _hoisted_1 = ["id"];
var _hoisted_2 = ["id", "tabindex", "aria-label", "aria-expanded", "aria-controls", "aria-disabled", "onClick", "onKeydown"];
var _hoisted_3 = { class: "p-panelmenu-header-content" };
var _hoisted_4 = ["href", "onClick"];
var _hoisted_5 = { class: "p-menuitem-text" };
var _hoisted_6 = ["href"];
var _hoisted_7 = { class: "p-menuitem-text" };
var _hoisted_8 = ["id", "aria-labelledby"];
var _hoisted_9 = {
  key: 0,
                ...
                $options.getItemProp(item, "to") && !$options.isItemDisabled(item) ? (openBlock(), createBlock(_component_router_link, {
                  ...
                  default: withCtx(({ navigate, href, isActive, isExactActive }) => [
                    createBaseVNode("a", {
                      ...
                      createBaseVNode("span", _hoisted_5, toDisplayString($options.getItemLabel(item)), 1)
                    ], 10, _hoisted_4)
                  ]),
                  _: 2
                  ...
                  createBaseVNode("span", _hoisted_7, toDisplayString($options.getItemLabel(item)), 1)
                ], 10, _hoisted_6))
          ...
          createVNode(Transition, { name: "p-toggleable-content" }, {
            default: withCtx(() => [
              withDirectives(createBaseVNode("div", {
                ...
                $options.getItemProp(item, "items") ? (openBlock(), createElementBlock("div", _hoisted_9, [
