...
var _hoisted_1$1 = ["href", "aria-current", "onClick"];
var _hoisted_2$1 = {
  key: 1,
  class: "p-menuitem-text"
};
var _hoisted_3$1 = ["href", "target", "aria-current"];
var _hoisted_4$1 = {
  key: 1,
  class: "p-menuitem-text"
};
      ...
      $props.item.to ? (openBlock(), createBlock(_component_router_link, {
        ...
        default: withCtx(({ navigate, href, isActive, isExactActive }) => [
          createBaseVNode("a", {
            ...
            $props.item.label ? (openBlock(), createElementBlock("span", _hoisted_2$1, toDisplayString($options.label()), 1)) : createCommentVNode("", true)
          ], 10, _hoisted_1$1)
        ]),
        _: 1
        ...
        $props.item.label ? (openBlock(), createElementBlock("span", _hoisted_4$1, toDisplayString($options.label()), 1)) : createCommentVNode("", true)
      ], 10, _hoisted_3$1))
...
var _hoisted_1 = { class: "p-breadcrumb p-component" };
var _hoisted_2 = { class: "p-breadcrumb-list" };
var _hoisted_3 = {
  key: 0,
  class: "p-menuitem-separator"
};
var _hoisted_4 = createBaseVNode("span", {
    ...
    createBaseVNode("ol", _hoisted_2, [
      ...
      (openBlock(true), createElementBlock(Fragment, null, renderList($props.model, (item, i) => {
        return openBlock(), createElementBlock(Fragment, {
          ...
          $props.home || i !== 0 ? (openBlock(), createElementBlock("li", _hoisted_3, _hoisted_5)) : createCommentVNode("", true),
