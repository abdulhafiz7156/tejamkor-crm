...
var _hoisted_2 = ["id", "disabled", "tabindex", "aria-labelledby", "aria-label", "aria-expanded", "aria-controls"];
var _hoisted_3 = { class: "p-treeselect-label-container" };
var _hoisted_4 = { class: "p-treeselect-token-label" };
var _hoisted_5 = ["aria-expanded"];
var _hoisted_6 = createBaseVNode("span", { class: "p-treeselect-trigger-icon pi pi-chevron-down" }, null, -1);
var _hoisted_7 = {
  key: 0,
          ...
          $props.display === "comma" ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
            ...
            (openBlock(true), createElementBlock(Fragment, null, renderList($options.selectedNodes, (node) => {
              return openBlock(), createElementBlock("div", {
                ...
                createBaseVNode("span", _hoisted_4, toDisplayString(node.label), 1)
              ]);
            }), 128)),
          ...
          default: withCtx(() => [
            $data.overlayVisible ? (openBlock(), createElementBlock("div", mergeProps({
              ...
              createBaseVNode("div", {
                ...
                $options.emptyOptions ? (openBlock(), createElementBlock("div", _hoisted_7, [
