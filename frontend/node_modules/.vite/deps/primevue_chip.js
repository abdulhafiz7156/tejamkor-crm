  ...
  return $data.visible ? (openBlock(), createElementBlock("div", {
    ...
    renderSlot(_ctx.$slots, "default", {}, () => [
      $props.image ? (openBlock(), createElementBlock("img", {
        key: 0,
        src: $props.image
      }, null, 8, _hoisted_2)) : $props.icon ? (openBlock(), createElementBlock("span", {
        key: 1,
        class: normalizeClass($options.iconClass)
      }, null, 2)) : createCommentVNode("", true),
      $props.label ? (openBlock(), createElementBlock("div", _hoisted_3, toDisplayString($props.label), 1)) : createCommentVNode("", true)
    ]),
    $props.removable ? (openBlock(), createElementBlock("span", {
      key: 0,
      tabindex: "0",
