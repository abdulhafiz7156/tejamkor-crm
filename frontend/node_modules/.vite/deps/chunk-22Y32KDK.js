...
var _hoisted_4 = createBaseVNode("div", { class: "p-progressbar-value p-progressbar-value-animate" }, null, -1);
var _hoisted_5 = [
  _hoisted_4
];
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", {
    ...
    $options.determinate ? (openBlock(), createElementBlock("div", {
      ...
      $props.value != null && $props.value !== 0 && $props.showValue ? (openBlock(), createElementBlock("div", _hoisted_2, [
        renderSlot(_ctx.$slots, "default", {}, () => [
          createTextVNode(toDisplayString($props.value + "%"), 1)
        ])
      ])) : createCommentVNode("", true)
    ], 4)) : createCommentVNode("", true),
    $options.indeterminate ? (openBlock(), createElementBlock("div", _hoisted_3, _hoisted_5)) : createCommentVNode("", true)
  ], 10, _hoisted_1);
}
...
//# sourceMappingURL=chunk-22Y32KDK.js.map
