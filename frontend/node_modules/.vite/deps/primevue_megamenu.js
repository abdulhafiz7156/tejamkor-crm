...
var _hoisted_1$1 = ["id", "aria-label", "aria-disabled", "aria-expanded", "aria-haspopup", "aria-level", "aria-setsize", "aria-posinset"];
var _hoisted_2$1 = ["onClick", "onMouseenter"];
var _hoisted_3$1 = ["href", "onClick"];
var _hoisted_4 = { class: "p-menuitem-text" };
...
var _hoisted_8 = { class: "p-megamenu-grid" };
var _hoisted_9 = ["id"];
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("ul", null, [
    $props.submenu ? (openBlock(), createElementBlock("li", {
      key: 0,
      ...
      role: "presentation"
    }, toDisplayString($options.getItemLabel($props.submenu)), 7)) : createCommentVNode("", true),
    (openBlock(true), createElementBlock(Fragment, null, renderList($props.items, (processedItem, index) => {
      return openBlock(), createElementBlock(Fragment, {
        ...
        $options.isItemVisible(processedItem) && !$options.getItemProp(processedItem, "separator") ? (openBlock(), createElementBlock("li", {
              ...
              $options.getItemProp(processedItem, "to") && !$options.isItemDisabled(processedItem) ? (openBlock(), createBlock(_component_router_link, {
                ...
                default: withCtx(({ navigate, href, isActive, isExactActive }) => [
                  withDirectives((openBlock(), createElementBlock("a", {
                    ...
                    createBaseVNode("span", _hoisted_4, toDisplayString($options.getItemLabel(processedItem)), 1)
                  ], 10, _hoisted_3$1)), [
                    [_directive_ripple]
                  ])
                ]),
                ...
                createBaseVNode("span", _hoisted_6, toDisplayString($options.getItemLabel(processedItem)), 1),
          ...
          $options.isItemVisible(processedItem) && $options.isItemGroup(processedItem) ? (openBlock(), createElementBlock("div", _hoisted_7, [
      ...
      if (grouped) {
        if (this.vertical) {
          if (ObjectUtils.isNotEmpty(this.activeItem) && this.activeItem.key === processedItem.key) {
            ...
            if (grouped2) {
              this.onItemChange({ originalEvent: event, processedItem: processedItem2 });
              this.focusedItemInfo = { index: -1, key: processedItem2.key, parentKey: processedItem2.parentKey };
              this.searchValue = "";
            }
          }
        }
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", {
    ...
    _ctx.$slots.start ? (openBlock(), createElementBlock("div", _hoisted_2, [
    ...
    _ctx.$slots.end ? (openBlock(), createElementBlock("div", _hoisted_3, [
