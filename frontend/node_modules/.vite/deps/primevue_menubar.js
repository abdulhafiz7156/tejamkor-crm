    ...
    (openBlock(true), createElementBlock(Fragment, null, renderList($props.items, (processedItem, index) => {
      return openBlock(), createElementBlock(Fragment, {
        ...
        $options.isItemVisible(processedItem) && !$options.getItemProp(processedItem, "separator") ? (openBlock(), createElementBlock("li", {
              ...
              $options.getItemProp(processedItem, "to") && !$options.isItemDisabled(processedItem) ? (openBlock(), createBlock(_component_router_link, {
                ...
                default: withCtx(({ navigate, href, isActive, isExactActive }) => [
                  withDirectives((openBlock(), createElementBlock("a", {
                    ...
                    createBaseVNode("span", _hoisted_4$1, toDisplayString($options.getItemLabel(processedItem)), 1)
                  ], 10, _hoisted_3$1)), [
                    [_directive_ripple]
                  ])
                ]),
                ...
                $options.getItemProp(processedItem, "items") ? (openBlock(), createElementBlock("span", {
                  key: 1,
          ...
          }, null, 8, ["menuId", "focusedItemId", "items", "mobileActive", "activeItemPath", "template", "exact", "level"])) : createCommentVNode("", true)
        ...
        $options.isItemVisible(processedItem) && $options.getItemProp(processedItem, "separator") ? (openBlock(), createElementBlock("li", {
          ...
          role: "separator"
        }, null, 14, _hoisted_7)) : createCommentVNode("", true)
      ], 64);
    }), 128))
  ]);
}
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", {
    ...
    }, $props.buttonProps), _hoisted_4, 16, _hoisted_2)) : createCommentVNode("", true),
    ...
    _ctx.$slots.end ? (openBlock(), createElementBlock("div", _hoisted_5, [
