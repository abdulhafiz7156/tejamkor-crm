...
var _hoisted_2 = ["id", "aria-label", "aria-disabled", "aria-expanded", "aria-haspopup", "aria-level", "aria-setsize", "aria-posinset"];
...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createBlock(Transition, {
    ...
    default: withCtx(() => [
      ($props.root ? true : $props.visible) ? (openBlock(), createElementBlock("ul", _hoisted_1, [
        (openBlock(true), createElementBlock(Fragment, null, renderList($props.items, (processedItem, index) => {
          return openBlock(), createElementBlock(Fragment, {
            ...
            $options.isItemVisible(processedItem) && !$options.getItemProp(processedItem, "separator") ? (openBlock(), createElementBlock("li", {
                  ...
                  $options.getItemProp(processedItem, "to") && !$options.isItemDisabled(processedItem) ? (openBlock(), createBlock(_component_router_link, {
                    ...
                    default: withCtx(({ navigate, href, isActive, isExactActive }) => [
                      withDirectives((openBlock(), createElementBlock("a", {
                        ...
                        createBaseVNode("span", _hoisted_5, toDisplayString($options.getItemLabel(processedItem)), 1)
                      ], 10, _hoisted_4)), [
                        [_directive_ripple]
                      ])
                    ]),
                    ...
                    createBaseVNode("span", _hoisted_7, toDisplayString($options.getItemLabel(processedItem)), 1),
                    $options.getItemProp(processedItem, "items") ? (openBlock(), createElementBlock("span", _hoisted_8)) : createCommentVNode("", true)
                  ], 10, _hoisted_6)), [
                    [_directive_ripple]
                  ])
              ...
              $options.isItemVisible(processedItem) && $options.isItemGroup(processedItem) ? (openBlock(), createBlock(_component_ContextMenuSub, {
                key: 0,
              ...
              }, null, 8, ["id", "menuId", "focusedItemId", "items", "template", "activeItemPath", "exact", "level", "visible"])) : createCommentVNode("", true)
