...
var _hoisted_4 = { class: "p-listbox-filter-container" };
var _hoisted_5 = ["placeholder", "aria-owns", "aria-activedescendant", "tabindex"];
var _hoisted_6 = {
  role: "status",
  "aria-live": "polite",
  class: "p-hidden-accessible"
};
var _hoisted_7 = ["id", "aria-multiselectable", "aria-label", "aria-labelledby", "aria-activedescendant", "aria-disabled"];
var _hoisted_8 = ["id"];
var _hoisted_9 = ["id", "aria-label", "aria-selected", "aria-disabled", "aria-setsize", "aria-posinset", "onClick", "onMousedown", "onMousemove"];
var _hoisted_10 = {
  key: 0,
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", {
    ...
    $props.filter ? (openBlock(), createElementBlock("div", _hoisted_3, [
      ...
      createBaseVNode("span", _hoisted_6, toDisplayString($options.filterResultMessageText), 1)
          ...
          createBaseVNode("ul", {
            ...
            (openBlock(true), createElementBlock(Fragment, null, renderList(items, (option, i) => {
              return openBlock(), createElementBlock(Fragment, {
                ...
                ], 12, _hoisted_8)) : withDirectives((openBlock(), createElementBlock("li", {
                  key: 1,
                  id: $data.id + "_" + $options.getOptionIndex(i, getItemOptions),
                  style: normalizeStyle({ height: itemSize ? itemSize + "px" : void 0 }),
            ...
            $data.filterValue && (!items || items && items.length === 0) ? (openBlock(), createElementBlock("li", _hoisted_10, [
              renderSlot(_ctx.$slots, "emptyfilter", {}, () => [
                createTextVNode(toDisplayString($options.emptyFilterMessageText), 1)
              ])
            ])) : !$props.options || $props.options && $props.options.length === 0 ? (openBlock(), createElementBlock("li", _hoisted_11, [
    ...
    !$props.options || $props.options && $props.options.length === 0 ? (openBlock(), createElementBlock("span", _hoisted_12, toDisplayString($options.emptyMessageText), 1)) : createCommentVNode("", true),
