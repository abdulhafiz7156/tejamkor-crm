...
var _hoisted_2 = ["tabindex", "aria-label", "role", "aria-checked", "aria-disabled", "onClick", "onKeydown", "onBlur"];
    ...
    (openBlock(true), createElementBlock(Fragment, null, renderList($props.options, (option, i) => {
      return withDirectives((openBlock(), createElementBlock("div", {
        ...
        renderSlot(_ctx.$slots, "option", {
          ...
          createBaseVNode("span", _hoisted_3, toDisplayString($options.getOptionLabel(option)), 1)
        ])
      ], 42, _hoisted_2)), [
        [_directive_ripple]
      ]);
